...
import { V2, V2ListOrdersParams, V2ListOrdersResponse } from "./resources/v2/v2.mjs";
...
export declare class Dinari {
     ...
     */
    constructor({ baseURL, apiKeyID, apiSecretKey, ...opts }?: ClientOptions);
    /**
    ...
    protected apiKeyIDAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    protected apiSecretKeyAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined>;
    ...
    private _makeAbort;
    private buildBody;
    static Dinari: typeof Dinari;
    static DEFAULT_TIMEOUT: number;
    static DinariError: typeof Errors.DinariError;
...
export declare namespace Dinari {
    ...
    export { V2 as V2, type V2ListOrdersResponse as V2ListOrdersResponse, type V2ListOrdersParams as V2ListOrdersParams, };
}
