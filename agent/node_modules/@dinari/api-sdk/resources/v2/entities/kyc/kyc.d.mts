...
import * as KYCAPI from "./kyc.mjs";
import * as DocumentAPI from "./document.mjs";
import { Document, DocumentRetrieveParams, DocumentRetrieveResponse, DocumentUploadParams, KYCDocument, KYCDocumentType } from "./document.mjs";
 ...
 */
export declare class KYC extends APIResource {
...
export declare namespace KYCInfo {
    /**
     * KYC information for an `Entity` in the baseline jurisdiction.
     */
    interface BaselineKYC {
        /**
         * ID of the KYC check.
         */
        id: string;
...
export declare namespace UsKYCCheckData {
    /**
     * Information to affirm that the individual has read, agreed to, and signed
     * Alpaca's customer agreement, found here:
     * https://files.alpaca.markets/disclosures/library/AcctAppMarginAndCustAgmt.pdf
     */
    interface AlpacaCustomerAgreement {
        /**
     ...
     * Integration Guide.
     */
    interface NonProfessionalTraderAttestation {
        /**
...
export declare namespace KYCSubmitParams {
    interface CreateBaselineKYCInput {
        /**
...
export declare namespace KYC {
    export { type BaselineKYCCheckData as BaselineKYCCheckData, type KYCInfo as KYCInfo, type KYCStatus as KYCStatus, type UsKYCCheckData as UsKYCCheckData, type KYCCreateManagedCheckResponse as KYCCreateManagedCheckResponse, type KYCSubmitParams as KYCSubmitParams, };
    export { Document as Document, type KYCDocument as KYCDocument, type KYCDocumentType as KYCDocumentType, type DocumentRetrieveResponse as DocumentRetrieveResponse, type DocumentRetrieveParams as DocumentRetrieveParams, type DocumentUploadParams as DocumentUploadParams, };
}
//# sourceMappingURL=kyc.d.mts.map