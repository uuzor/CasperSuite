...
class Document extends resource_1.APIResource {
     ...
     * ```
     */
    retrieve(kycID, params, options) {
        const { entity_id } = params;
        return this._client.get((0, path_1.path) `/api/v2/entities/${entity_id}/kyc/${kycID}/document`, options);
    }
    /**
     ...
     * ```
     */
    upload(kycID, params, options) {
        const { entity_id, document_type, ...body } = params;
        return this._client.post((0, path_1.path) `/api/v2/entities/${entity_id}/kyc/${kycID}/document`, (0, uploads_1.multipartFormRequestOptions)({ query: { document_type }, body, ...options }, this._client));
    }
}
