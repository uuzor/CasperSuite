...
import * as ExternalAPI from "./external.mjs";
import { External, ExternalConnectParams, ExternalGetNonceParams, ExternalGetNonceResponse, WalletChainID } from "./external.mjs";
 ...
 */
export declare class WalletResource extends APIResource {
    external: ExternalAPI.External;
    /**
...
export declare namespace WalletResource {
    ...
    export { External as External, type WalletChainID as WalletChainID, type ExternalGetNonceResponse as ExternalGetNonceResponse, type ExternalConnectParams as ExternalConnectParams, type ExternalGetNonceParams as ExternalGetNonceParams, };
}
