 ...
 */
export declare class OrderFulfillments extends APIResource {
    /**
...
export declare namespace OrderFulfillmentQueryResponse {
    /**
     * Information about a fulfillment of an `Order`. An order may be fulfilled in
     * multiple transactions.
     */
...
export declare namespace OrderFulfillments {
    export { type Fulfillment as Fulfillment, type OrderFulfillmentQueryResponse as OrderFulfillmentQueryResponse, type OrderFulfillmentRetrieveParams as OrderFulfillmentRetrieveParams, type OrderFulfillmentQueryParams as OrderFulfillmentQueryParams, };
}
//# sourceMappingURL=order-fulfillments.d.mts.map