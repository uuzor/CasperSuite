 ...
 */
class Eip155 extends resource_1.APIResource {
    /**
     ...
     * ```
     */
    createPermit(accountID, body, options) {
        return this._client.post((0, path_1.path) `/api/v2/accounts/${accountID}/order_requests/eip155/permit`, {
            body,
            ...options,
        });
    }
     ...
     * ```
     */
    createPermitTransaction(accountID, body, options) {
        return this._client.post((0, path_1.path) `/api/v2/accounts/${accountID}/order_requests/eip155/permit_transaction`, {
            body,
            ...options,
        });
    }
     ...
     * ```
     */
    submit(accountID, body, options) {
        return this._client.post((0, path_1.path) `/api/v2/accounts/${accountID}/order_requests/eip155`, { body, ...options });
    }
}
